...
<div id="header_title"> Employee Search System </div>

<div id="menu">

  <a class="button_menu" href="<?= base_url()."index.php/hr"?>">Main Menu</a>
  <a class="button_menu" href="<?= base_url()."index.php/hr/add_employee_view"?>">Add Employee</a>
  <a class="button_menu" href="<?= base_url()."index.php/hr/move_employee_search"?>">Edit Employee</a>
  <a class="button_menu" href="<?= base_url()."index.php/hr/remove_employee_search"?>">Remove Employee</a>
  <a class="button_menu" onClick="logout()" >Logout</a>
